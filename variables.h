...
float PEDAL_DEADZONE = 0.5;         /// Minimum pedal position to activate torque, measured in Nm

float POT_OFFSET= 79;               /// The physical difference calculated between the accelerator sensors
float MAX_DIFF = 90;                /// Maximum difference is 10% of the 0 to 1023 Arduino values
